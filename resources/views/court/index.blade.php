				...
				@if(count($courts) > 0)
					@foreach ($courts as $court)
						<tr>
							...
							<td class="action">
								<a href="{{route('courts.edit',$court->id)}}" title="Éditer le terrain" class="edit">
									<i class="fa fa-pencil fa-lg action" aria-hidden="true"></i>
								</a>
								
								{{ Form::open(array('url' => route('courts.destroy', $court->id), 'method' => 'delete')) }}
									<button type="submit" class="button-delete" data-name="{{ $court->name }}" data-type="court">
